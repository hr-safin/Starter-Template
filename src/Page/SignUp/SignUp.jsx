...
const SignUp = () => {
    ...
    const {user, createUser,profileUpdate,googleLogin} = useContext(AuthContext)
              ...
              <form onSubmit={handleSubmit(onSubmit)} class="space-y-4 md:space-y-6" >
                ...
                <div>
                      ...
                      <input
                       ...
                       {errors.name && <span className='py-3 text-red-500'>name is required</span>}
                  </div>
                  ...
                  <div>
                      ...
                      type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" />
                       {errors.email && <span className='py-3 text-red-500'>email is required</span>}
                  </div>
                  ...
                  <div>
                   ...
                   <p className=" text-red-500 pt-2">password must be 6 character</p>
                  )}
                       {errors.password?.type === "maxLength" && (
                   <p className=" text-red-500 pt-2">password must be less than 20 character</p>
                  )}
                   ...
                   <p className=" text-red-500 pt-2">password must have one lower case one upper case one number and one special character </p>
                  )}
                  </div>
                  <div>
                      ...
                      {...register("photo", { required: true })}
                       type="text" name="photo" id="photo" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="type your photo url "/>
                           {errors.password?.type === "required" && (
                  ...
                  <p class="text-sm font-light text-gray-700 dark:text-gray-400">
                      Already have an account? <Link to="/signIn"  class="font-medium text-gray-800 hover:underline dark:text-primary-500">Sign In</Link>
                  </p>
                </div>
              </form>
          </div>
